...
OPT_2_FILES:=$(wildcard src_opt2/*.c)
OPT_3_FILES:=$(wildcard src_opt3/*.c)
...
OPT_2_OBJS:=$(OPT_2_FILES:src_opt2/%.c=%.o)
OPT_3_OBJS:=$(OPT_3_FILES:src_opt3/%.c=%.o)
...
test: $(TEST_OBJS) $(TEST_HELPER_OBJS) $(SRC_OBJS) $(OPT_1_OBJS) $(OPT_2_OBJS) $(OPT_3_OBJS)
	$(CC) -static $(TEST_OBJS) $(OPT_1_OBJS) $(OPT_2_OBJS) $(OPT_3_OBJS) $(TEST_HELPER_OBJS) $(SRC_OBJS) -o test.exe test/main.c
